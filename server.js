...
// ... (기존 API들: cctv, traffic 등은 그대로 유지) ...

// ============================================================
// ★ [신규] 취약 구간 정보 API (CSV 기반)
// ============================================================
...
// 차량 감지 API (YOLO 기반) - Base64 이미지 처리
